...
if choice == x: #if user inputs 'investment' do the following:
    ...
    if deposit <= 0:
        ...
        if rate <= 0:
            ...
            if year <= 0:
                print("Error!, Number Of Years Must Be Greather Than Zero.")
            else:
...
if choice == y: #if user inputs 'bond' do the following:
    ...
    if house <= 0:
        print ("Error!, House Value Must Be Greater Than Zero.")
    else:
        ...
        if rate <= 0:
            ...
            if month <= 0:
                print ("Error!, Number Of Months Must Be Greater Than Zero")
            else:
